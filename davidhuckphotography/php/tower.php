...
<head>
    ...
    <title>Tower Print</title>

</head>
<body class="p-2 border">
    
    <h1>Product Purchased! Tower Print</h1>
    ...
    <div>
        <ul>
            <li><a href="../images/tower/tower.jpg" download>Tower JPG</a></li>
            <li><a href="../images/tower/tower.png" download>Tower PNG</a></li>
