...
<head>
    ...
    <title>NYC Street Print</title>

</head>
<body class="p-2 border">
    
    <h1>Product Purchased! NYC Street Print</h1>
    ...
    <div>
        <ul>
            <li><a href="../images/nycSign/sign.jpg" download>Benz JPG</a></li>
            <li><a href="../images/nycSign/sign.png" download>Benz PNG</a></li>
